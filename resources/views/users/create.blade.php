...
@section('content')
    ...
    <form method="post" class="form" method="post" action="/users/store">
        @csrf
        @method('post')
        ...
        <input type="password" name="password" id="password" class="control" required="true" value="{{ old('password') }}">
